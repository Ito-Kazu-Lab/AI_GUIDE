...
- When making edits, AI tools must not violate the contents of the above documents (in particular, the prohibitions and points of caution in [docs/rules.en.md](docs/rules.en.md)).
- AI tools must maintain the structure and heading hierarchy of the documents, and follow the existing style.
- AI tools must confirm with the user before proceeding with edits when something is unclear.
